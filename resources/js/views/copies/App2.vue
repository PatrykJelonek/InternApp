        ...
        >
            <v-list nav dense>
                ...
                <v-list-item-group class="mt-1" active-class="primary--text primary--darken-1">
                    <v-subheader class="caption font-weight-medium text-uppercase hidden">Ogólne</v-subheader>
                ...
                <v-subheader class="caption font-weight-medium text-uppercase hidden">Użytkownik</v-subheader>
                <v-list-group
                    no-action
